...
import {Callback, Guess, MessageType, Status} from "../types.ts";
...
export class TestleDOM {
    ...
    public setMessage(message: string, type: MessageType): void {
	...
	private createForm(): void {
		...
		this.input.classList.add(constants.CLASSNAME_INPUT)
